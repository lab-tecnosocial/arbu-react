    ...
    <BrowserRouter>
      ...
      <Suspense fallback={<main style={{ padding: "1rem" }}>Cargando…</main>}>
        <Routes>
          ...
          <Route path="dashboard" element={<ProtectedRoute element={<Dashboard />} requiresAuthorization={true} />} />
          ...
          <Route path="campanas" element={<ProtectedRoute element={<ListaCampanas />} requiresAuthorization={true} />} />
          <Route path="campanas/:id" element={<ProtectedRoute element={<CampanaLayout />} requiresAuthorization={true} />}>
